...
| 6 | `phase-06-llamacpp` | `phase-05-backend-contracts` | 6 | **this PR** |
...
- `phase-06-llamacpp` (this PR): Phase 6 llama.cpp backend. Builds green, `go test ./...` passes, `golangci-lint run ./...` = 0 issues, neutralization grep clean.
- **Top of stack:** `phase-06-llamacpp`. **Next:** Phase 7 (MLX backend) on `phase-07-mlx`, based on `phase-06-llamacpp`.
